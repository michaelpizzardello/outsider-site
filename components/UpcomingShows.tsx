            ...
            <div key={ex.handle} className="py-16 md:py-24">
              <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-14 xl:gap-16 2xl:gap-20 items-start">
                ...
                <div className="lg:col-span-5 2xl:col-span-5">
                  ...
                  {/* Artist (big) + italic show title */}
                  <div className="mt-4">
                    <h2 className="text-3xl md:text-4xl xl:text-5xl leading-tight">
                      <Link
                    ...
                    {ex.artist && ex.title ? (
                      <div className="mt-1 text-xl md:text-2xl xl:text-3xl italic">
                        {ex.title}
                      </div>
                    ) : null}
                  </div>
                ...
                {/* Image column (no rounded corners) */}
